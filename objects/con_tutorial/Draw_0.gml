...
{
	var _surf = surface_create(VIEW_W, VIEW_H);
	...
	draw_set_font(font);
	var _c = c_white;
	draw_text_ext_transformed_color(VIEW_W/2, VIEW_H*0.05, text, -1, VIEW_W-(xbuffer*2), 1, 1, 0, _c,_c,_c,_c, text_alpha);
	...
	draw_text_ext_transformed_color(VIEW_W/2, VIEW_H*0.95, _text, -1, VIEW_W, 1, 1, 0, _c,_c,_c,_c, instruction_alpha);
